...
parseRoutines.push({ reg: new RegExp("(&quot;|&#39;)(.*?)(&quot;|&#39;)"), replacement: "<span class='javascript_string'>$1$2$3</span>" });
...
parseRoutines.push({ reg: new RegExp("(switch)"), replacement: "<span class='javascript_switch'>$1</span>" });
...
parseRoutines.push({ reg: new RegExp("0x([\\dABCDEF]+)"), replacement: "<span class='javascript_number'>0x$1</span>" });
